...
const AddDesignModal: React.FC<AddDesignModalProps> = ({ isOpen, onClose, onFileSelect }) => {
  if (!isOpen) {
    return null;
  }
    ...
    >
      ...
      >
        ...
        <div className="text-center">
          <h2 className="text-2xl font-extrabold mb-4 text-zinc-800">Add Your Own Design</h2>
        </div>
