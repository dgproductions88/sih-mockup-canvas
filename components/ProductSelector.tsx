...
import DesignCard from './ObjectCard';

interface DesignSelectorProps {
    designs: Design[];
    onSelect: (design: Design) => void;
    onAddOwnDesignClick: () => void;
}
...
const DesignSelector: React.FC<DesignSelectorProps> = ({ designs, onSelect, onAddOwnDesignClick }) => {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto text-center animate-fade-in">
            <div className="relative flex items-center">
                ...
                >
                    {designs.map(design => (
                         <div key={design.id} className="snap-center shrink-0 w-52 md:w-64">
                            <DesignCard
                                design={design}
                                isSelected={false}
